...
func (rm *resourceManager) sdkUpdate(
	...
	var resp *svcsdk.StartMetricStreamsOutput
	_ = resp
	resp, err = rm.sdkapi.StartMetricStreams(ctx, input)
	rm.metrics.RecordAPICall("UPDATE", "StartMetricStreams", err)
	if err != nil {
		return nil, err
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) newUpdateRequestPayload(
	...
	r *resource,
	delta *ackcompare.Delta,
) (*svcsdk.StartMetricStreamsInput, error) {
	res := &svcsdk.StartMetricStreamsInput{}
